...
export function SmoothScroll(){const router=useRouter(),pathname=usePathname();useEffect(()=>{
 ...
 if(isDashboard){document.documentElement.classList.add('dashboard-native-scroll');return()=>document.documentElement.classList.remove('dashboard-native-scroll');}
